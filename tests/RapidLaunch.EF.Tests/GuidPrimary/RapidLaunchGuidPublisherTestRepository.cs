...
namespace RapidLaunch.EF.Tests.GuidPrimary
{
    ...
    {
        /// <inheritdoc />
        public RapidLaunchGuidPublisherTestRepository(DbContext context, IPublishingBus publishingBus, Func<IQueryable<TestGuidEntity>, IQueryable<TestGuidEntity>>? includeFunc = null)
