...
namespace RapidLaunch.Common
{
    ...
    public interface IDeleteEntitiesAsync<in TRoot, TId>
        where TRoot : IAggregateRoot<TId>
    {
        ...
        Task<RapidLaunchStatus> DeleteEntitiesAsync(IEnumerable<TRoot> roots, CancellationToken cancellationToken = default);
    }
}
