...
namespace RapidLaunch.Common
{
    ...
    public interface IGetEntitiesByIdAsync<TRoot, in TId>
        where TRoot : IAggregateRoot<TId>
    {
        ...
        Task<List<TRoot>> GetEntitiesByIdAsync(IEnumerable<TId> identifiers, CancellationToken cancellationToken = default);
    }
}
