namespace NBaseRepository.Common
{
        ...
        where TId : struct
    {
        ...
        Task<IReadOnlyList<TEntity>> SearchEntitiesAsync(IQuery<TEntity, TId> queryObject, CancellationToken cancellationToken);
        ...
        /// <param name="cancellationToken">A <see cref="CancellationToken"/>.</param>
        /// <returns>A <see cref="Task"/> of type <see cref="IReadOnlyList{TEntity}"/>.</returns>
        Task<IReadOnlyList<TEntity>> SearchEntitiesAsync(IQuery<TEntity, TId> queryObject, Func<IQueryable<TEntity>, IQueryable<TEntity>> includeFunc, CancellationToken cancellationToken);
    }
}
